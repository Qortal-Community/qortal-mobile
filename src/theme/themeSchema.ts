...
// Canonical theme schema (mirrors Hub + Extension export):
// {
//   id?: string,
//   name: string,
//   light: { mode: "light", primary/background/text/border/other... },
//   dark: { mode: "dark", ... }
// }
// Additional keys are ignored, but each palette must contain the shared color buckets above.
